...
Colour has one meaning each, on a warm grey ground (the palette of the author's [bivariate climate map](https://yusnelkis.github.io/Portafolio/bivariate-climate-map/)): vibrant blue is installations and their CO₂, teal is *down* or *closed*, magenta is *up*, an ink ring is the pinned selection A, sector colours appear only when asked. Every hue was checked with a palette validator for contrast and colour-vision deficiency on that ground.
