...
| Outputs | **Download CSV** of the selection (45 columns, tonne precision) · **Report (PDF)**: one page with filters, KPIs, map, breakdowns, largest sites and the open card · **Copy link**: every filter lives in the URL |
...
- Planned: hotspot aggregation (hexagons of ~20 km) to read industrial clusters as systems; comparison of two selections side by side.
